...
1.  Query the RDDL 2 PLMNT service of the Testnet or the Maintnet by calling `https://testnet-r2p.rddl.io/receiveaddress/` or `https://r2p.rddl.io/receiveaddress/` with your **planetmint address** appended, e.g. for address _`plmnt1atfrnm80xyg86s85xp0av2ukap8n4ap7pevptm`_
