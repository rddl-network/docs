...
<figure><img src="../.gitbook/assets/image (22).png" alt=""><figcaption><p>Layer Overview</p></figcaption></figure>
...
The attestation process is executed on the Energy Agent. Detailed information can be found at [installation.md](../getting-started/the-energyagent/installation.md "mention"). During the initial attestation process of an Energy Agent, the specifics of its investment capabilities can be defined. These definitions implicitly represent the token issuance process of the device.&#x20;
